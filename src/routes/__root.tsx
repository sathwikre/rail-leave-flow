...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Railway Worker Leave Management System" },
      { name: "description", content: "Manage leave requests, attendance and worker schedules for railway operations." },
      { property: "og:title", content: "Railway Worker Leave Management System" },
      { name: "twitter:title", content: "Railway Worker Leave Management System" },
      { property: "og:description", content: "Manage leave requests, attendance and worker schedules for railway operations." },
      { name: "twitter:description", content: "Manage leave requests, attendance and worker schedules for railway operations." },
