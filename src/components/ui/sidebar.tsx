...
>(({ className, showIcon = false, ...props }, ref) => {
  // Avoid generating a random value during SSR render to prevent hydration mismatches.
  // Use a stable default on the server, then set a randomized width on the client.
